# BMB Mod - Base Game Modifications
_SOURCE: Modifications to base game items (generated from xml/core-items-mods/)_
# Modifications to base game items (generated from xml/core-items-mods/)
```
...
<GameItemTypes>
	<GameItemType InternalName="Staff_Leht">
        <DisplayName>Leht Staff</DisplayName>
        ...
        <AIData AIPersonality="AI_General">
            ...
            <AIPriority>212</AIPriority>
        </AIData>
        <ArtDef>Staff_Leht_ArtDef</ArtDef>
        <GameItemTypeArtDef InternalName="Staff_Leht_ArtDef">
            <GameItemTypeModelPack InternalName="Staff_Leht_Default">
                <IconFile>W_Staff_Leht_Icon_01.png</IconFile>
                <TintR>0</TintR>
                <TintG>0</TintG>
                <TintB>0</TintB>
                ...
                <GameItemTypeModel>
                    ...
                    <Color_Metal>151, 39,39</Color_Metal>
        <EffectAttachment>
