...
<Spells>
	<SpellDef InternalName="BMB_AlchemicalSurprise">
		...
		<GameModifier>
			...
			<DisplayName>Healing Nectar!</DisplayName>
			<Value>100</Value>
		</GameModifier>
		<GameModifier>
			<ModType>GiveItem</ModType>
		...
		<GameModifier>
			...
			<DisplayName>Vial of Poison!</DisplayName>
			<Value>100</Value>
		</GameModifier>
		<GameModifier>
			<ModType>GiveItem</ModType>
		...
		<GameModifier>
			...
			<DisplayName>Dark Concoction!</DisplayName>
			<Value>100</Value>
		</GameModifier>
		<GameModifier>
			<ModType>GiveItem</ModType>
		...
		<GameModifier>
			...
			<DisplayName>Fire Resistance Potion!</DisplayName>
			<Value>100</Value>
		</GameModifier>
		<GameModifier>
			<ModType>GiveItem</ModType>
		...
		<GameModifier>
			...
			<DisplayName>Growth Potion!</DisplayName>
			<Value>100</Value>
		</GameModifier>
		<GameModifier>
			<ModType>GiveItem</ModType>
		...
		<GameModifier>
			...
			<DisplayName>Healing Potion!</DisplayName>
			<Value>100</Value>
		</GameModifier>
		<GameModifier>
			<ModType>GiveItem</ModType>
		...
		<GameModifier>
			...
			<DisplayName>Iru Elixir!</DisplayName>
			<Value>100</Value>
		</GameModifier>
		<GameModifier>
			<ModType>GiveItem</ModType>
		...
		<GameModifier>
			...
			<DisplayName>Ironeer Ale!</DisplayName>
			<Value>100</Value>
		</GameModifier>
		<GameModifier>
			<ModType>GiveItem</ModType>
		...
		<GameModifier>
			...
			<DisplayName>Pariden Wine!</DisplayName>
			<Value>100</Value>
		</GameModifier>
		<GameModifier>
			<ModType>GiveItem</ModType>
		...
		<GameModifier>
			...
			<DisplayName>Prismatic Potion!</DisplayName>
			<Value>100</Value>
		</GameModifier>
		<GameModifier>
			<ModType>GiveItem</ModType>
		...
		<GameModifier>
			...
			<DisplayName>Restoration Potion!</DisplayName>
			<Value>100</Value>
		</GameModifier>
        <GameModifier>
			<ModType>GiveItem</ModType>
			<Attribute>Potion_TrogBlood</Attribute>
			<DisplayName>Trog Blood!</DisplayName>
			<Value>100</Value>
		</GameModifier>
		<GameModifier>
			<ModType>GiveItem</ModType>
	...
	<SpellDef InternalName="BMB_AmuletOfTheBlackMindedEffect">
        <DisplayName>Amulet of the Black Minded Effect</DisplayName>
        <Description>Target unit has a 33% chance of suffering critical hits from all attacks.</Description>
        ...
        <GameModifier>
			...
			<DisplayName>Graveseal</DisplayName>
            <Duration>-1</Duration>
	...
	<SpellDef InternalName="BMB_AttackFrenzy">
        <DisplayName>Attack Frenzy</DisplayName>
        <Description>Target unit gains +1 Attack with each successful strike for the duration of combat.</Description>
        ...
        <GameModifier>
            ...
            <DisplayName>Attack +1</DisplayName>
            <Duration>-1</Duration>
            <Value>1</Value>
        </GameModifier>
        <AIData AIPersonality="AI_General">
	...
	<SpellDef InternalName="BMB_Beguile">
        <DisplayName>Beguile</DisplayName>
        <Description>Victim has a 50% chance to swing at a random unit in melee instead of his target.</Description>
        ...
        <GameModifier>
            ...
            <DisplayName>Beguiled</DisplayName>
            <Duration>-1</Duration>
            <Value>50</Value>
        </GameModifier>
        <AIData AIPersonality="AI_General">
	...
	<SpellDef InternalName="BMB_BeltOfWeariness_Effect">
        <DisplayName>Belt of Weariness Effect</DisplayName>
        <Description>Units struck suffer -1 to Stamina and growth is halted for 3 turns.</Description>
        ...
        <GameModifier>
            ...
            <DisplayName>Stamina Loss</DisplayName>
            <Value>-1</Value>
        </GameModifier>
		<GameModifier>
            <ModType>Unit</ModType>
            ...
            <DisplayName>Weariness</DisplayName>
	...
	<SpellDef InternalName="BMB_BloodCandles">
        ...
        <Description>+2 Hit Points to allies whenever an enemy is killed</Description>
	...
	<SpellDef InternalName="BMB_BowAttack_RuthlessPelter">
        <DisplayName>Ruthless Pelter Bow Attack</DisplayName>
        <Description>Attack a unit from a distance with a single arrow from your bow, push them back and possibly knock them prone.</Description>
        <Image>Action_BowArrow.png</Image>
        <IconFG>Action_BowArrow.png</IconFG>
        <SpellBookSortCategory>Unit</SpellBookSortCategory>
        <SpellBookSortSubCategory>UnitDamage</SpellBookSortSubCategory>
	...
	<SpellDef InternalName="BMB_BullsEye">
        <DisplayName>Bull's Eye</DisplayName>
        <Description>+300% Attack when using a Bow but lose your next turn.</Description>
	...
	<SpellDef InternalName="BMB_BulwarkOfTheBrute">
        <DisplayName>Bulwark of the Brute Effect</DisplayName>
        <Description>Launch a double Attack and knock the victim back 1 tile.</Description>
	...
	<SpellDef InternalName="BMB_ChokerSpore">
        ...
        <Description>Select a target area and choke your opponents for 3 Poison damage per round.</Description>
	...
	<SpellDef InternalName="BMB_Chop">
        ...
        <Description>Strike twice.</Description>
	...
	<SpellDef InternalName="BMB_CorrosiveDagger">
        <DisplayName>Corrosive Dagger Effect</DisplayName>
        <Description>Unit takes 2-4 Acid damage per round</Description>
	...
	<SpellDef InternalName="BMB_CripplingBlow">
        <DisplayName>Crippling Blow</DisplayName>
        <Description>Double your Attack, but you lose your next action.</Description>
	...
	<SpellDef InternalName="BMB_CuttingSurface">
        <DisplayName>Cutting Surface</DisplayName>
        <Description>Attacker takes 2 damage.</Description>
	...
	<SpellDef InternalName="BMB_DaggerOfCorruption">
        <DisplayName>Dagger Of Corruption Effect</DisplayName>
        <Description>Reduces the attack of the target by 2 (+1 per death shard) unless they resist.</Description>
	...
	<SpellDef InternalName="BMB_DeathCircle">
        <DisplayName>Death Circle</DisplayName>
        <Description>A circle of destructive energy hitting adjacent enemies for 4 damage + twice the caster's level (half if resisted).</Description>
	...
	<SpellDef InternalName="BMB_DimensionalTranslocation">
        <DisplayName>Dimensional Translocation</DisplayName>
        <Description>Teleport to any location in Tactical combat and take one action.</Description>
	...
	<SpellDef InternalName="BMB_DismantlingStroke">
		<DisplayName>Black Spike's Dismantling Stroke</DisplayName>
        <Description>Launch a 400% Attack, but you lose your next action.</Description>
        <FormattedDescription>Launch a %d Attack, but you lose your next action.</FormattedDescription>
	...
	<SpellDef InternalName="BMB_DrainLife">
        <DisplayName>Drain Life</DisplayName>
        <Description>Transfers 12 hit points (+2 per death shard) from enemy unit to the caster.</Description>
	...
	<SpellDef InternalName="BMB_ElementalMyriad">
        <DisplayName>Elemental Myriad</DisplayName>
        <Description>Grants your army random Elemental damage for the duration of the battle.</Description>
		...
		<GameModifier>
            ...
            <DisplayName>Frost Power</DisplayName>
            <Duration>-1</Duration>
            <Value>2</Value>
        </GameModifier>
        <GameModifier>
            ...
            <DisplayName>Fire Power</DisplayName>
            <Duration>-1</Duration>
            <Value>2</Value>
        </GameModifier>
		<GameModifier>
            ...
            <DisplayName>Lightning Power</DisplayName>
            <Duration>-1</Duration>
            <Value>2</Value>
        </GameModifier>
		<GameModifier>
            ...
            <DisplayName>Poison Power</DisplayName>
            <Duration>-1</Duration>
            <Value>2</Value>
        </GameModifier>
        <AIData AIPersonality="AI_General">
	...
	<SpellDef InternalName="BMB_ForgingExcellence">
		<DisplayName>Forging Excellence</DisplayName>
        <Description>Army gains +6 Attack, +6 Critical Chance and +100% Critical Damage</Description>       
	...
	<SpellDef InternalName="BMB_FreezingBlood">
        <DisplayName>Freezing Blood</DisplayName>
        <Description>Unit takes 5 Cold damage per round</Description>
	...
	<SpellDef InternalName="BMB_FreezingJet">
        <DisplayName>Freezing Jet</DisplayName>
        <Description>Fire a Freezing Jet through 3 units in a line (+3 per water shard).</Description>
	...
	<SpellDef InternalName="BMB_FreezingRay">
        <DisplayName>Freezing Ray</DisplayName>
        <Description>A freezing ray that deals cold damage for double the caster's level (+3 per water shard).</Description>
	...
	<SpellDef InternalName="BMB_GildarTouch">
        <DisplayName>Gildar Touch</DisplayName>
        <Description>The wearer gains +1 Gold whenever it strikes and enemy.</Description>
        ...
        <GameModifier>
            ...
            <ApplyToCaster>1</ApplyToCaster>
            <DisplayName>+1 Gold</DisplayName>
            <Value>1</Value>
        </GameModifier>
        <AIData AIPersonality="AI_General">
            <AIPriority>5</AIPriority>
	...
	<SpellDef InternalName="BMB_Haste_Mass">
        <DisplayName>Mass Haste</DisplayName>
        <Description>Target army is +5 to Initiative (+1 per air shard).</Description>
	...
	<SpellDef InternalName="BMB_HeartOfTheTarget">
		<DisplayName>Heart of the Target</DisplayName>
		<Description>Ignores 20% of the victim's defense when using a Bow</Description>
		<Image>Ability_MasterArcher_Icon.png</Image>
	...
	<SpellDef InternalName="BMB_IceBomb">
        <DisplayName>Ice Bomb</DisplayName>
        <Description>Select your target and blast away for 18 Cold damage.</Description>
	...
	<SpellDef InternalName="BMB_Icebreaker_Effect">
        <DisplayName>Icebreaker Effect</DisplayName>
        <Description>Attacker has a 50% chance of inflicting extra 4-10 damage.</Description>
        <IconFG>Ability_ReapI_Icon.png</IconFG>
        <SpellBookSortCategory>Unit</SpellBookSortCategory>
        <SpellBookSortSubCategory>Other</SpellBookSortSubCategory>
        <SpellType>Tactical</SpellType>
	...
	<SpellDef InternalName="BMB_IceRing">
		<DisplayName>Ice Ring</DisplayName>
		<Description>A ring of ice hitting adjacent enemies for double the caster's level + 2 per water shard (half if resisted)</Description>
		<Image>S_Freeze_Painting.png</Image>
        <IconFG>S_FrozenBones_Icon.png</IconFG>		
		<Cooldown>6</Cooldown>
        <SpellBookSortCategory>Unit</SpellBookSortCategory>
	...
	<SpellDef InternalName="BMB_InsectSwarm">
        <DisplayName>Insect Swarm</DisplayName>
        <Description>A harassing cloud of insects which reduces Accuracy and Dodge by 40% and lowers initiative by 3 for 5 turns unless resisted.</Description>
	...
	<SpellDef InternalName="BMB_InsectPlague">
        <DisplayName>Insect Plague</DisplayName>
        <Description>A harassing plague of insects targeting all enemies which reduces Accuracy and Dodge by 40% and lowers initiative by 3 for 5 turns unless resisted.</Description>
	...
	<SpellDef InternalName="BMB_JinxDoll">
        <DisplayName>Curse of the Jinx Doll</DisplayName>
        <Description>Inflicts a random horrific curse upon an enemy unit.</Description>
		...
		<GameModifier>
            ...
            <Attribute>DefendableDamage</Attribute>
            <AttackStat>UnitStat_Attack_Poison</AttackStat>
			<DisplayName>Poisoned</DisplayName>
            <Duration>-1</Duration>
            <Effect>E_Poison_Particle</Effect>
	...
	<SpellDef InternalName="BMB_LaceratingSpokes">
        <DisplayName>Lacerating Spokes</DisplayName>
        <Description>Attacker takes 2-5 damage.</Description>
        <IconFG>Ability_ReapI_Icon.png</IconFG>
        <SpellBookSortCategory>Unit</SpellBookSortCategory>
        <SpellBookSortSubCategory>Other</SpellBookSortSubCategory>
        <SpellType>Tactical</SpellType>
	...
	<SpellDef InternalName="BMB_LeopardRush">
        <DisplayName>Leopard Rush</DisplayName>
        <Description>+3 Initiative the first time the unit takes a hit.</Description>
        <Image>T_Haste_Painting.png</Image>
        <IconFG>T_Celerity_Icon.png</IconFG>
		<CanStack>0</CanStack>
        <SpellBookSortCategory>Unit</SpellBookSortCategory>
	...
	<SpellDef InternalName="BMB_LittleRevenger">
        <DisplayName>Chop</DisplayName>
        <Description>Retaliate twice, with a vengeance.</Description>
		...
		<GameModifier>
			<ApplyToCaster>1</ApplyToCaster>
			<DisplayName>Revenge!</DisplayName>
        </GameModifier>
        <AIData AIPersonality="AI_General">
            <AIPriority>5</AIPriority>
        </AIData>
	...
	<SpellDef InternalName="BMB_LostBarrowhillWine">
        <DisplayName>Lost Barrowhill Wine Effect</DisplayName>
        <Description>Lost Barrowhill Wine Effect - Random properties.</Description>
		...
		<GameModifier>
			...
			<DisplayName>Spell Resistance!</DisplayName>
            <Value>5</Value>
        </GameModifier>
		<GameModifier>
            <ModType>Unit</ModType>
			...
			<DisplayName>Spell Mastery!</DisplayName>
            <Value>5</Value>
        </GameModifier>
		<GameModifier>
            <ModType>Unit</ModType>
			...
			<DisplayName>Spell Power!</DisplayName>
            <Value>5</Value>
        </GameModifier>
		<GameModifier>
            <ModType>Unit</ModType>
			...
			<DisplayName>Eagle Eye!</DisplayName>
            <Value>1</Value>
        </GameModifier>
		<GameModifier>
            <ModType>Unit</ModType>
            <Attribute>AdjustUnitStat</Attribute>
            <StrVal>UnitStat_Attack_Cold</StrVal>
			<DisplayName>Ice Touch!</DisplayName>
            <Value>2</Value>
        </GameModifier>
		<GameModifier>
            <ModType>Unit</ModType>
            <Attribute>AdjustUnitStat</Attribute>
            <StrVal>UnitStat_Attack_Fire</StrVal>
			<DisplayName>Flame Touch!</DisplayName>
            <Value>2</Value>
        </GameModifier>
		<GameModifier>
            <ModType>Unit</ModType>
            <Attribute>AdjustUnitStat</Attribute>
            <StrVal>UnitStat_Attack_Lightning</StrVal>
			<DisplayName>Lightning Touch!</DisplayName>
            <Value>2</Value>
        </GameModifier>
		<GameModifier>
            <ModType>Unit</ModType>
            <Attribute>AdjustUnitStat</Attribute>
            <StrVal>UnitStat_Attack_Poison</StrVal>
			<DisplayName>Poison Touch!</DisplayName>
            <Value>2</Value>
        </GameModifier>		
		<GameModifier>
            <ModType>Unit</ModType>
			...
			<DisplayName>Oops!</DisplayName>            
        </GameModifier>
		<GameModifier>
            <ModType>Unit</ModType>
            <Attribute>UnlockUnitAbility</Attribute>
            <StrVal>Inaccurate</StrVal>
			<DisplayName>How Awkward!</DisplayName>            
        </GameModifier>
		<GameModifier>
            <ModType>Unit</ModType>
            <Attribute>AdjustUnitStat</Attribute>
            <StrVal>UnitStat_Accuracy</StrVal>
			<DisplayName>Sharper Aim!</DisplayName>
            <Value>5</Value>            
        </GameModifier>
		<GameModifier>
            <ModType>Unit</ModType>
			...
			<DisplayName>Fortitude!</DisplayName>
            <Value>5</Value>            
        </GameModifier>
		<GameModifier>
            <ModType>Unit</ModType>
            <Attribute>AdjustUnitStat</Attribute>
            <StrVal>UnitStat_Dodge</StrVal>
			<DisplayName>Artful Dodger!</DisplayName>
            <Value>5</Value>            
        </GameModifier>
        <GameModifier>
            <ModType>Unit</ModType>
            ...
            <DisplayName>Nothing but a headache!</DisplayName>            
        </GameModifier>        
        <AIData AIPersonality="AI_General">
            <AIPriority>100</AIPriority>
        </AIData>        
	...
	<SpellDef InternalName="BMB_MendingHands">
        <DisplayName>Mending Hands</DisplayName>
        <Description>Heals target unit by 12 (+2 per life shard).</Description>
	...
	<SpellDef InternalName="BMB_Mindblast">
        <DisplayName>Mind Blast</DisplayName>
        <Description>Does damage equal to 1/6 of the caster's added Spell Mastery and Spell Damage. Half if resisted</Description>
	...
	<SpellDef InternalName="BMB_OvumPhilosophorum">
        <DisplayName>Ovum Philosophorum</DisplayName>
        <Description>Convert 100 metal into 300 gildar.</Description>
	...
	<SpellDef InternalName="BMB_ParalyzingAcid">
        <DisplayName>Paralyzing Acid</DisplayName>
        <Description>Target enemy suffers -10 Dodge and takes 3-6 damage per turn.</Description>
	...
	<SpellDef InternalName="BMB_ParalyzingCold">
        <DisplayName>Paralyzing Cold</DisplayName>
        <Description>Unit takes 3 Cold damage per round</Description>
        <Image>T_Blizzard_Painting.png</Image>
        <IconFG>S_FrozenBones_Icon.png</IconFG>
        <SpellBookSortCategory>Unit</SpellBookSortCategory>
        <SpellBookSortSubCategory>UnitDamage</SpellBookSortSubCategory>
	...
	<SpellDef InternalName="BMB_PenitentsRestitution">
        <DisplayName>Penitent's Restitution</DisplayName>
        <Description>Heals all allies and caster gains 3 hit points permanently</Description>
	...
	<SpellDef InternalName="BMB_PlagueTouch">
        <DisplayName>Plague Touch</DisplayName>
        <Description>Halves the Poison Resistance of Targets, Poisons them and spreads Infection.</Description>
        ...
        <GameModifier>
            ...
            <DisplayName>Contagion</DisplayName>
            <Duration>-1</Duration>
	...
	<SpellDef InternalName="BMB_PowerPunch">
		<DisplayName>Black Spike's Power Punch</DisplayName>
        <Description>+50% Attack and the victim gets knocked back 2 tiles.</Description>
	...
	<SpellDef InternalName="BMB_PowerSweep">
        <DisplayName>Power Sweep</DisplayName>
        <Description>Attack all enemies within a 1 tile radius, push them back and knock them prone.</Description>
	...
	<SpellDef InternalName="BMB_PrismaticBelt">
        <DisplayName>Prismatic Belt Effect</DisplayName>
        <Description>Does 4-8 extra elemental damage.</Description>
        <IconFG>S_Freeze_Icon.png</IconFG>
        <SpellBookSortCategory>Unit</SpellBookSortCategory>
        <SpellBookSortSubCategory>UnitDamage</SpellBookSortSubCategory>
        <SpellType>Tactical</SpellType>
	...
	<SpellDef InternalName="BMB_RebounderEffect">
        <DisplayName>Rebounder Effect</DisplayName>
        <Description>Attacker is knocked back 1 tile.</Description>
        <IconFG>Ability_ShieldBash_Icon.png</IconFG>
        <SpellBookSortCategory>Unit</SpellBookSortCategory>
        <SpellBookSortSubCategory>Other</SpellBookSortSubCategory>
        <SpellType>Tactical</SpellType>
	...
	<SpellDef InternalName="BMB_RejuvenatingFusion">
        <DisplayName>Rejuvenating Fusion Effect</DisplayName>
        <Description>Rejuvenating Fusion Effect - Healing an injury comes with the added benefit of a random permanent increase in Hit Points.</Description>
        <Image>T_Wellspring_Painting.png</Image>
        <IconFG>T_Wellspring_Icon.png</IconFG>
        <SpellBookSortCategory>Unit</SpellBookSortCategory>
        <SpellBookSortSubCategory>Other</SpellBookSortSubCategory>
		...
		<GameModifier>
            ...
            <Attribute>AdjustUnitStat</Attribute>
            <StrVal>UnitStat_HitPoints</StrVal>
			<DisplayName>+1 Hit Points</DisplayName>
            <Value>1</Value>            
        </GameModifier>
		<GameModifier>
            <ModType>Unit</ModType>
            <Attribute>AdjustUnitStat</Attribute>
            <StrVal>UnitStat_HitPoints</StrVal>
			<DisplayName>+2 Hit Points</DisplayName>
            <Value>2</Value>            
        </GameModifier>	
        <GameModifier>
            <ModType>Unit</ModType>
            <Attribute>AdjustUnitStat</Attribute>
            <StrVal>UnitStat_HitPoints</StrVal>
            <DisplayName>+3 Hit Points</DisplayName>
            <Value>3</Value>
        </GameModifier>        
        <AIData AIPersonality="AI_General">
            <AIPriority>5</AIPriority>
	...
	<SpellDef InternalName="BMB_Riptide">
        ...
        <Description>Summon a wave that does 8 damage (+2 per water shard) to 3 adjacent enemies.</Description>
	...
	<SpellDef InternalName="BMB_RodentRepellent">
        <DisplayName>Rodent Repellent</DisplayName>
        <Description>Creates a rodent free zone in target city (+15% more food per Essence and -10% Unrest).</Description>
	...
	<SpellDef InternalName="BMB_SaintlyAura">
		<DisplayName>Saintly Aura</DisplayName>
        <Description>Adjacent friendly units regenerate 4 hit points per turn.</Description>
	...
	<SpellDef InternalName="BMB_Scrambler">
        <DisplayName>Scrambler Effect</DisplayName>
        <Description>Disrupts a spell an enemy unit is casting and causes them to lose their next turn unless they resist.</Description>                
	...
	<SpellDef InternalName="BMB_ShacklesOfEnslavement">
        ...
        <Description>Enslaves a trained unit unless they resist. Caster must be adjacent to the target.</Description>
        <Image>S_DestinysGift_Painting.png</Image>
	...
	<SpellDef InternalName="BMB_ShatterResistance">
        <DisplayName>Shatter Resistance</DisplayName>
        <Description>Target loses 3 Defense and 6 Spell Resistance points per strike</Description>
        <Image>Tech_Arcane_Weapons.png</Image>
		...
		<GameModifier>
            ...
            <Attribute>AdjustUnitStat</Attribute>
            <StrVal>UnitStat_MagicResist</StrVal>
            <DisplayName>Resist Loss</DisplayName>
            <Duration>-1</Duration>
			<Value>-8</Value>	
        </GameModifier>
        <GameModifier>
            ...
            <Attribute>AdjustUnitStat</Attribute>
            <StrVal>UnitStat_Defense_Pierce</StrVal>
            <DisplayName>Defense Loss</DisplayName>
            <Duration>-1</Duration>
			<Value>-4</Value>
        </GameModifier>
        <AIData AIPersonality="AI_General">
	...
	<SpellDef InternalName="BMB_ShieldSlam">
        <DisplayName>Shield Slam</DisplayName>
        <Description>Launch a normal Attack, knocks targets back 1 tile and knocks them prone.</Description>
	...
	<SpellDef InternalName="BMB_Slow_Mass">
        ...
        <Description>Target army suffers -5 to Initiative (-1 per water shard) unless its members resist.</Description>
	...
	<SpellDef InternalName="BMB_StaminaDrain">
        <DisplayName>Stamina Drain</DisplayName>
        <Description>Attack that reduces the victim's Stamina to 0 if it hits</Description>
	...
	<SpellDef InternalName="BMB_Stoneskin">
        ...
        <Description>Target champion's Defense is raised by 3 (+1 per earth shard).</Description>
	...
	<SpellDef InternalName="BMB_SummonAerialAlly">
        <DisplayName>Summon Aerial Ally</DisplayName>
        <Description>Smmon a random level 6 Aerial Ally</Description>
	...
	<SpellDef InternalName="BMB_SummonArachnid">
        <DisplayName>Summon Arachnid</DisplayName>
        <Description>Smmon a random level 6 Spider</Description>
	...
	<SpellDef InternalName="BMB_SummonBear">
        <DisplayName>Summon Bear</DisplayName>
        <Description>Summons a Bear at the same level as the caster.</Description>
	...
	<SpellDef InternalName="BMB_SummonLupus">
        <DisplayName>Summon Lupus</DisplayName>
        <Description>Smmon a random level 8 Canine Friend</Description>
	...
	<SpellDef InternalName="BMB_SwampGasExplosion">
        <DisplayName>Swamp Gas Explosion</DisplayName>
        <Description>A violent methane explosion which damages units within a 1-tile radius for twice the caster's level + 8; half if resisted.</Description>
	...
	<SpellDef InternalName="BMB_SyphonStrength">
        <DisplayName>Syphon Strength</DisplayName>
        <Description>The victim's Attack is lowered by 25%, and the caster's Attack is increased by 25% unless the victim resists.</Description>
	...
	<SpellDef InternalName="BMB_TempestuousWrath">
        <DisplayName>Tempestuous Wrath</DisplayName>
        <Description>+4 Lightning Attack for the duration of combat.</Description>
	...
	<SpellDef InternalName="BMB_Thunderstorm">
        ...
        <Description>Lightning strikes all enemies group for 20 Lightning damage (+4 per air shard).</Description>
	...
	<SpellDef InternalName="BMB_TwinShaft">
        <DisplayName>Twin Shaft</DisplayName>
        <Description>Strike twice.</Description>
	...
	<SpellDef InternalName="BMB_WallbreakerEffect">
        <DisplayName>Wallbreaker Effect</DisplayName>
        <Description>Target's defense is reduced by 30% per strike</Description>
        ...
        <GameModifier>
            ...
            <Attribute>AdjustUnitStat</Attribute>
            <StrVal>UnitStat_Defense_Pierce</StrVal>
            <DisplayName>Fractured</DisplayName>
            <Duration>-1</Duration>            
            <Calculate InternalName="Calc" ValueOwner="TargetUnit">
	...
	<SpellDef InternalName="BMB_WaywardDeathBane_Effect">
        <DisplayName>Wayward Deathbane Effect</DisplayName>
        <Description>Has a 25% chance of healing the wielder for 8 hit points with a successful hit.</Description>
        <IconFG>Ability_ReapI_Icon.png</IconFG>
        <SpellBookSortCategory>Unit</SpellBookSortCategory>
        <SpellBookSortSubCategory>Other</SpellBookSortSubCategory>
        <SpellType>Tactical</SpellType>
	...
	<SpellDef InternalName="BMB_Yank">
        <DisplayName>Yank</DisplayName>
        <Description>Attack that also has a chance to knock the enemy prone unless they resist.</Description>
        <Image>Ability_Slow.png</Image>
        ...
        <GameModifier>
            <ModType>TacticalUnit</ModType>
            <Attribute>TargetKnockedProne</Attribute>
            <DisplayName>Yanked</DisplayName>
            <Duration>1</Duration>
        </GameModifier>
        <AIData AIPersonality="AI_General">
            <AIPriority>5</AIPriority>
	...
	<SpellDef InternalName="Haste">
        <DisplayName>Haste</DisplayName>
        <Description>Target unit is +5 to Initiative (+1 per air shard).</Description>
	...
	<SpellDef InternalName="Slow">
        <DisplayName>Slow</DisplayName>
        <Description>Target enemy unit suffers -5 to Initiative (-1 per water shard) unless they resist.</Description>
...
<AbilityBonuses>
    ...
    <AbilityBonus InternalName="BMB_FamousAbility">        
        <AbilityBonusOption InternalName="BMB_Famous">
            <DisplayName>Famous</DisplayName>
            <Description>+1 Fame per Season</Description>
