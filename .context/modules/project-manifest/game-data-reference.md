# Project Manifest - Game Data Reference
_SOURCE: Base game XML schemas, GameCore file inventory, entry element structures, Reforged additions_
# Base game XML schemas, GameCore file inventory, entry element structures, Reforged additions
```
...
```
###  Path: `\docs\agents\project-manifest/game-data-reference.md`
