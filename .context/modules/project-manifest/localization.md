# Project Manifest - Localization
_SOURCE: Localization system: base game format, BMB per-entry translation files, TXT_BMB_* key conventions_
# Localization system: base game format, BMB per-entry translation files, TXT_BMB_* key conventions
```
...
```
###  Path: `\docs\agents\project-manifest/localization.md`
